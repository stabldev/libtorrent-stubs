# This file provides type stubs for the libtorrent Python bindings.
# Source: https://github.com/arvidn/libtorrent/blob/master/bindings/python/libtorrent/__init__.pyi
# Derived from libtorrent C++ API documentation and existing Python binding structure.
#
# Original libtorrent project: https://www.libtorrent.org/
# Copyright (c) Arvid Norberg
# License: (Refer to libtorrent's license, typically BSD-3-Clause)
#
# This stub package (libtorrent-stubs) is distributed under the MIT License.
# Copyright (c) 2025 stabldev

import datetime
from collections.abc import Callable, Iterable, Iterator, Mapping
from typing import Any, TypedDict, overload, override
...
_PathLike = str | bytes
_Entry = bytes | int | list[Any] | dict[bytes, Any] | tuple[int, ...]
...
class session:
    ...
    def add_extension(self, _extension: object) -> None: ...
    ...
    @overload
    def add_torrent(
        self, _bdecoded: dict[str, Any] | _AddTorrentParamsDict
    ) -> torrent_handle: ...
    ...
    def listen_on(
        self, min: int, max: int, interface: str | None = ..., flags: int = ...
    ) -> None: ...
    ...
    def set_peer_class(
        self, _class: int, _info: dict[str, Any] | _PeerClassInfo
    ) -> None: ...
...
class torrent_handle:
    ...
    def replace_trackers(
        self, _entries: Iterable[announce_entry | dict[str, Any]]
    ) -> None: ...
...
class torrent_status:
    ...
    is_loaded: bool
    is_seeding: bool
    last_download: datetime.datetime | None
    last_scrape: int
    last_seen_complete: int
    last_upload: datetime.datetime | None
    list_peers: int
    list_seeds: int
    moving_storage: bool
    name: str
    ...
    torrent_file: torrent_info | None
    total_done: int
    total_download: int
    total_failed_bytes: int
    total_payload_download: int
